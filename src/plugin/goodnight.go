...
func (p *goodNight) IsMatched(msg param.GroupMessage) bool {
	return util.IsWordInMessage("n", []string{"晚安"}, msg)
}

func (p *goodNight) DoMatched(msg param.GroupMessage) error {
