...
var (
	CarrotHomeworkDeleteFailed  = "好像删不了诶~"
	CarrotHomeworkDeleteSuccess = "删掉啦"

	CarrotHomeworkShowFailed = "诶...怎么查不了了!呼叫饲养员!"
	CarrotHomeworkShowEmpty  = "现在没有要写的作业哦~大家一起摸鱼吧!"
	CarrotHomeworkShowStart  = "作业来咯~你可接稳啦!"

	CarrotHomeworkAddFailed  = "就不让你布置这个作业~略略略"
	CarrotHomeworkAddSuccess = "布置好啦"
